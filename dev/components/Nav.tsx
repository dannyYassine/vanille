          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a
                ...
                onclick={() => window.history.pushState({}, '', '/app/dashboard')}
              >
            ...
            <li class="nav-item">
              <a class="nav-link text-white " onclick={() => window.history.pushState({}, '', '/app/list-example')}>
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">receipt_long</i>
                </div>
                <span class="nav-link-text ms-1">List example</span>
              </a>
            </li>
            <li class="nav-item">
